...
- **永豐大戶等級變更**：手動調整等級時記錄，提醒下月可能降級

**範例記錄：**
```
2026-03-16 14:30  國泰 CUBE  方案切換  樂饗購 → 玩數位  [自動]
...
- **國泰 CUBE**：等級、今日方案
- **台新 Richart**：等級、今日方案
- **玉山 Unicard**：當月方案（按月設定）、**本月是否已切換至 UP 選**（checkbox）
- **永豐大戶**：**當前等級**（大大/大戶/大戶 Plus）、**預期等級**（供計算用，可設定與當前不同）
- **中信華航**：卡等、哩程換算率
